...
- CDC、オーケストレーションなどの利用
![ポスト作成後のフロー](/md/assets/images/image.png)
**重要なこと**
- グラフDBでの関係性の管理
...
![検索サービス](/md/assets/images/image-1.png)
...
![最終構造](/md/assets/images/image-2.png)
...
##### 大まかなシステム設計
![リーダーボード構成](/md/assets/images/image-3.png)
...
- 上記のLambdaでの構成図
![lambda](/md/assets/images/image-4.png)
...
- 以下の2種類の大きなサービスが存在
![予約システム](/md/assets/images/image-5.png)
...
![GraphQL](/md/assets/images/image-6.png)
- Apolloの使用
...
**支払処理アーキテクチャ**
![予約アーキテクチャ](/md/assets/images/image-7.png)
- Walletサービス
...
**ダイナミックプライシング**
![dynamic pricing](/md/assets/images/image-8.png)
